...
public class PrometeoCarController : MonoBehaviour
{
    ...
    //PRIVATE VARIABLES
      ...
      */
      ...
      Vector2 movementInput; // ADDITION
      bool isPressingSpace; // ADDITION
    ...
    void Update()
    {
      ...
      */
      if (useTouchControls && touchControlsSetup){
        ...
        bool isPressingW = movementInput.y > 0;
        bool isPressingS = movementInput.y < 0;
        bool isPressingA = movementInput.x < 0;
        ...
        if(!isPressingS && !isPressingW && !isPressingSpace && !deceleratingCar){
          InvokeRepeating("DecelerateCar", 0f, 0.1f);
          deceleratingCar = true;
        }
        if(!isPressingA && !isPressingD && steeringAxis != 0f){
          ResetSteeringAngle();
        }
